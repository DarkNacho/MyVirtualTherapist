    ...
    >
      <Box sx={{ flex: 1, display: "flex", flexDirection: "column", gap: 1 }}>
        ...
        >
          ...
          >
            {t("practitionerSearchComponent.practitioners")}
          </Typography>
        ...
        <TextField
          variant="outlined"
          placeholder={t("practitionerSearchComponent.searchPractitioner")}
          size="small"
          fullWidth
          value={name}
      ...
      >
        <Box sx={{ p: 2, display: "flex", flexDirection: "column", gap: 1 }}>
          <TextField
            variant="outlined"
            placeholder={t("practitionerSearchComponent.searchByPhone")}
            size="small"
            fullWidth
            value={phone}
          ...
          <TextField
            variant="outlined"
            placeholder={t("practitionerSearchComponent.searchByRut")}
            size="small"
            fullWidth
            value={rut}
          ...
          <TextField
            variant="outlined"
            placeholder={t("practitionerSearchComponent.searchByEmail")}
            size="small"
            fullWidth
            value={email}
          ...
          <Button variant="contained" color="primary" onClick={handleSearch}>
            {t("practitionerSearchComponent.search")}
          </Button>
        </Box>
      </Popover>
    </Paper>
