    ...
    >
      ...
      >
        <Avatar
          ...
          alt={`${dummyPatient.name[0].given.join(" ")} ${
            dummyPatient.name[0].family
          }`}
        ...
        <Box sx={{ flexGrow: 1, display: "flex", flexDirection: "column" }}>
          <Typography
            ...
            sx={{ mb: 1 }}
          >
            {dummyPatient.name[0].given.join(" ")}{" "}
            ...
            <Grid item xs={12} md={6}>
              <Box sx={{ mb: 1 }}>
                ...
                <Typography variant="body2" component="span">
                  {dummyPatient.identifier[0].value}
                </Typography>
              </Box>
  ...
  const EncountersList = () => {
    ...
    const sessionDetails = {
      "12": {
        ...
        respRange: "14-18 RPM",
        notes:
          "La paciente presenta evolución favorable en parámetros cardiovasculares. Los episodios de desaturación son aislados y no persistentes.",
        symptoms: ["Fatiga leve", "Disnea ocasional"],
        recommendations: [
          "Continuar con monitorización",
          "Mantener frecuencia de sesiones actuales",
        ],
      },
      "11": {
        date: "05/03/2024",
        ...
        respRange: "13-17 RPM",
        notes:
          "Paciente reporta mejora en síntomas respiratorios aunque persiste fatiga con actividad física moderada.",
      ...
      "10": {
        ...
        respRange: "14-19 RPM",
        notes:
          "Evaluación integral presencial. Se realiza ajuste de tratamiento farmacológico. Se recomienda aumentar frecuencia de monitorización.",
      ...
      "9": {
        ...
        respRange: "15-19 RPM",
        notes:
          "Se detectaron episodios de taquicardia asociados a actividad física. Sensores inerciales registraron 8 eventos anómalos.",
        symptoms: ["Palpitaciones", "Fatiga"],
        recommendations: [
          "Evitar esfuerzos excesivos",
          "Programar consulta presencial",
        ],
      },
      "8": {
        date: "28/02/2024",
        ...
        respRange: "13-17 RPM",
        notes:
          "Se observa ligero episodio de desaturación durante la sesión que se recupera espontáneamente. La tendencia general de los signos vitales es estable.",
        symptoms: ["Disnea leve", "Fatiga moderada"],
        recommendations: [
          "Vigilar frecuencia cardíaca",
          "Mantener medicación actual",
        ],
      },
      "7": {
        date: "20/02/2024",
        ...
        respRange: "12-17 RPM",
        notes:
          "Sensores inerciales detectaron 5 eventos anómalos, principalmente movimientos bruscos asociados con episodios de tos.",
      ...
      "6": {
        ...
        respRange: "13-17 RPM",
        notes:
          "Los parámetros cardiorrespiratorios se mantienen dentro de límites normales durante toda la sesión. El tratamiento muestra buenos resultados.",
      ...
      "5": {
        ...
        respRange: "14-18 RPM",
        notes:
          "Paciente reporta mejoría en capacidad para realizar actividades cotidianas. Signos vitales estables.",
      ...
      "4": {
        ...
        respRange: "13-18 RPM",
        notes:
          "Sensores inerciales detectaron 6 eventos anómalos de tipo temblor de baja intensidad durante periodos de reposo.",
        symptoms: ["Temblores leves", "Ansiedad"],
        recommendations: [
          "Evaluar componente ansioso",
      ...
      "3": {
        ...
        recommendations: [
          ...
          "Monitorizar respuesta cardiovascular",
        ],
      },
      "2": {
        date: "25/01/2024",
        ...
        respRange: "15-19 RPM",
        notes:
          "Evaluación de seguimiento. Se observa mejora leve respecto a la evaluación inicial. Se ajusta tratamiento.",
        symptoms: ["Disnea moderada", "Fatiga con actividades básicas"],
        recommendations: [
          "Continuar con rehabilitación respiratoria",
      ...
      "1": {
        ...
        respRange: "16-20 RPM",
        notes:
          "Evaluación inicial completa. Se establece plan de tratamiento y monitorización. Se programa rehabilitación respiratoria.",
        symptoms: [
          "Disnea",
          "Fatiga",
    ...
    const handleOpenSessionDetail = (sessionId: string) => {
      ...
      if (session) {
        setSessionDetailDialog({
          ...
          sessionData:
            sessionDetails[sessionId as keyof typeof sessionDetails] || {},
        });
      }
    };
            ...
            {availableSessions.map((session) => (
              <Grid item xs={12} sm={6} md={4} key={session.id}>
                ...
                >
                  ...
                  >
                    Tipo:{" "}
                    {sessionDetails[session.id as keyof typeof sessionDetails]
                      ?.type ||
                      (parseInt(session.id) > 8
        ...
        >
          ...
          >
            <Box>
              ...
              <Typography variant="subtitle2" color="textSecondary">
                {sessionDetailDialog.sessionDate} •{" "}
                {sessionDetailDialog.sessionData.duration}
              </Typography>
            </Box>
            <IconButton
              edge="end"
            ...
            <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} sm={6} md={3}>
                      <Box>
                        ...
                        <Typography variant="body1">
                          {sessionDetailDialog.sessionData.type}
                        </Typography>
                      </Box>
                    </Grid>
                    <Grid item xs={12} sm={6} md={3}>
                      <Box>
                        ...
                        <Typography variant="body1">
                          {sessionDetailDialog.sessionData.professional}
                        </Typography>
                      </Box>
                    </Grid>
                    <Grid item xs={12} sm={6} md={3}>
                      <Box>
                        ...
                        <Typography variant="body1">
                          {sessionDetailDialog.sessionData.location}
                        </Typography>
                      </Box>
                    </Grid>
                    <Grid item xs={12} sm={6} md={3}>
                    ...
                    <Grid item xs={12} sm={4}>
                      ...
                      >
                        ...
                        <Typography
                          ...
                          fontWeight="bold"
                        >
                          {sessionDetailDialog.sessionData.spo2Avg}
                        </Typography>
                        <Typography variant="caption" color="text.secondary">
                          Rango: {sessionDetailDialog.sessionData.spo2Range}
                        </Typography>
                      </Box>
                    </Grid>
                    <Grid item xs={12} sm={4}>
                      ...
                      >
                        ...
                        <Typography
                          ...
                          fontWeight="bold"
                        >
                          {sessionDetailDialog.sessionData.hrAvg}
                        </Typography>
                        <Typography variant="caption" color="text.secondary">
                          Rango: {sessionDetailDialog.sessionData.hrRange}
                        </Typography>
                      </Box>
                    </Grid>
                    <Grid item xs={12} sm={4}>
                      ...
                      >
                        ...
                        <Typography
                          ...
                          fontWeight="bold"
                        >
                          {sessionDetailDialog.sessionData.respAvg}
                        </Typography>
                        <Typography variant="caption" color="text.secondary">
                          Rango: {sessionDetailDialog.sessionData.respRange}
                        </Typography>
                      </Box>
                    </Grid>
                  </Grid>
              ...
              <Grid item xs={12} md={6}>
                <Paper sx={{ p: 3, borderRadius: 2, height: "100%" }}>
                  ...
                  <Box component="ul" sx={{ pl: 2, mt: 1 }}>
                    {sessionDetailDialog.sessionData.recommendations?.map(
              ...
              <Grid item xs={12} md={6}>
                <Paper sx={{ p: 3, borderRadius: 2, height: "100%" }}>
                  ...
                  >
                    {sessionDetailDialog.sessionData.symptoms?.map(
          ...
          <DialogActions
            sx={{ p: 2, borderTop: `1px solid ${COLORS.gridLine}` }}
          >
            <Button
              onClick={handleCloseSessionDetail}
    ...
    <Paper sx={{ p: 3, mb: 3, borderRadius: 2, bgcolor: "white" }}>
      ...
      {dummyQuestionnaires.map((questionnaire) => (
        ...
        >
          ...
          <Typography variant="body2" color="textSecondary">
            Estado:{" "}
            {questionnaire.status === "completed" ? "Completado" : "Pendiente"}
          </Typography>
        </Box>
      ))}
    </Paper>
