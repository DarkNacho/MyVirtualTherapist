...
import { Grid, Paper, Typography, Box, Tab, Tabs, Button, IconButton, Tooltip as MuiTooltip, Dialog, DialogTitle, DialogContent, DialogActions, Avatar } from '@mui/material';
...
const LightDashboard: FC<DashboardProps> = ({ oxygenSaturationData, heartRateData, respiratoryRateData, patientId }) => {
  ...
  const inertialChartRef = useRef<ChartJS<'line', (number | null)[], string>>(null);
  const realtimeChartRef = useRef<ChartJS<'line', (number | null)[], string>>(null);
  const spo2RealtimeChartRef = useRef<ChartJS<'line', (number | null)[], string>>(null);
  ...
  const detailInertialChartRef = useRef<ChartJS<'line', (number | null)[], string>>(null);
  // Referencias para los gráficos de sesión
  const spo2SessionChartRef = useRef<ChartJS<'line', (number | null)[], string>>(null);
  const heartRateSessionChartRef = useRef<ChartJS<'line', (number | null)[], string>>(null);
  const respRateSessionChartRef = useRef<ChartJS<'line', (number | null)[], string>>(null);
  ...
  // Datos del gráfico de saturación de oxígeno
  ...
  // Datos del gráfico de frecuencia cardíaca
    ...
    datasets: [
      {
        ...
        backgroundColor: function(context: any) {
          const chart = context.chart;
          const {ctx} = chart;
          return createGradient(ctx, COLORS.redLine);
        },
        borderWidth: 2,
  ...
  // Datos de frecuencia respiratoria (gráfico de barras)
  ...
  const handleCloseDetail = () => {
    setDetailDialog({ open: false, title: '', value: '', chartType: '', description: '' });
  };
    ...
    <Paper sx={{ 
      ...
      <Box sx={{ 
        ...
        <Avatar 
          ...
          alt={`${dummyPatient.name[0].given.join(' ')} ${dummyPatient.name[0].family}`}
          src="/assets/profile.jpg"  // Ruta ficticia, deberías usar la foto real del paciente
        />
        
        <Box sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
          <Typography variant="h5" fontWeight="bold" color={COLORS.primary} sx={{ mb: 1 }}>
            {dummyPatient.name[0].given.join(' ')} <span style={{ fontWeight: 'normal' }}>{dummyPatient.name[0].family}</span>
          </Typography>
          
      <Grid container spacing={2}>
        <Grid item xs={12} md={6}>
              <Box sx={{ mb: 1 }}>
                <Typography variant="body2" color="textSecondary" component="span">RUT: </Typography>
                <Typography variant="body2" component="span">{dummyPatient.identifier[0].value}</Typography>
              </Box>
              
              <Box sx={{ mb: 1 }}>
                <Typography variant="body2" color="textSecondary" component="span">Teléfono: </Typography>
                <Typography variant="body2" component="span">{dummyPatient.telecom[0].value}</Typography>
              </Box>
        </Grid>
            
        <Grid item xs={12} md={6}>
              <Box sx={{ mb: 1 }}>
                <Typography variant="body2" color="textSecondary" component="span">Edad: </Typography>
                <Typography variant="body2" component="span">75</Typography>
              </Box>
              
              <Box sx={{ mb: 1 }}>
                <Typography variant="body2" color="textSecondary" component="span">Fecha nac.: </Typography>
                <Typography variant="body2" component="span">10/06/1948</Typography>
              </Box>
        </Grid>
            ...
            <Grid item xs={12} md={6}>
              <Box sx={{ mb: 1 }}>
                ...
                <Typography variant="body2" component="span">{dummyPatient.telecom[1].value}</Typography>
              </Box>
      </Grid>
            
            <Grid item xs={12} md={6}>
              <Box sx={{ mb: 1 }}>
                <Typography variant="body2" color="textSecondary" component="span">Sexo: </Typography>
                <Typography variant="body2" component="span">Femenino</Typography>
              </Box>
            </Grid>
          </Grid>
        </Box>
  ...
  const EncountersList = () => {
    // Estado para el diálogo de detalles de sesión
    ...
    // Datos detallados de cada sesión
    const sessionDetails = {
      '12': {
        date: '15/03/2024',
        duration: '45 minutos',
        type: 'Monitorización remota',
        ...
        respAvg: '16 RPM',
        respRange: '14-18 RPM',
        notes: 'La paciente presenta evolución favorable en parámetros cardiovasculares. Los episodios de desaturación son aislados y no persistentes.',
        symptoms: ['Fatiga leve', 'Disnea ocasional'],
        recommendations: ['Continuar con monitorización', 'Mantener frecuencia de sesiones actuales']
      },
      '11': {
        date: '05/03/2024',
        duration: '40 minutos',
        ...
        respAvg: '15 RPM',
        respRange: '13-17 RPM',
        notes: 'Paciente reporta mejora en síntomas respiratorios aunque persiste fatiga con actividad física moderada.',
        symptoms: ['Fatiga moderada', 'Disnea con esfuerzo'],
        recommendations: ['Ejercicios respiratorios diarios', 'Seguimiento en 10 días']
      },
      '10': {
        date: '03/03/2024',
        duration: '50 minutos',
        ...
        respAvg: '16 RPM',
        respRange: '14-19 RPM',
        notes: 'Evaluación integral presencial. Se realiza ajuste de tratamiento farmacológico. Se recomienda aumentar frecuencia de monitorización.',
        symptoms: ['Fatiga persistente', 'Tos seca ocasional'],
        recommendations: ['Ajuste de medicación', 'Aumentar ingesta de líquidos']
      },
      '9': {
        date: '01/03/2024',
        duration: '30 minutos',
        ...
        respAvg: '17 RPM',
        respRange: '15-19 RPM',
        notes: 'Se detectaron episodios de taquicardia asociados a actividad física. Sensores inerciales registraron 8 eventos anómalos.',
        symptoms: ['Palpitaciones', 'Fatiga'],
        recommendations: ['Evitar esfuerzos excesivos', 'Programar consulta presencial']
      },
      '8': {
        date: '28/02/2024',
        duration: '35 minutos',
        ...
        respAvg: '15 RPM',
        respRange: '13-17 RPM',
        notes: 'Se observa ligero episodio de desaturación durante la sesión que se recupera espontáneamente. La tendencia general de los signos vitales es estable.',
        symptoms: ['Disnea leve', 'Fatiga moderada'],
        recommendations: ['Vigilar frecuencia cardíaca', 'Mantener medicación actual']
      },
      '7': {
        date: '20/02/2024',
        duration: '40 minutos',
        ...
        respAvg: '14 RPM',
        respRange: '12-17 RPM',
        notes: 'Sensores inerciales detectaron 5 eventos anómalos, principalmente movimientos bruscos asociados con episodios de tos.',
        symptoms: ['Tos moderada', 'Molestia en garganta'],
        recommendations: ['Evaluar causas de la tos', 'Hidratar adecuadamente']
      },
      '6': {
        date: '15/02/2024',
        duration: '45 minutos',
        ...
        respAvg: '15 RPM',
        respRange: '13-17 RPM',
        notes: 'Los parámetros cardiorrespiratorios se mantienen dentro de límites normales durante toda la sesión. El tratamiento muestra buenos resultados.',
        symptoms: ['Fatiga leve'],
        recommendations: ['Continuar con mismo esquema terapéutico']
      },
      '5': {
        date: '10/02/2024',
        duration: '35 minutos',
        ...
        respAvg: '16 RPM',
        respRange: '14-18 RPM',
        notes: 'Paciente reporta mejoría en capacidad para realizar actividades cotidianas. Signos vitales estables.',
        symptoms: ['Fatiga disminuida'],
        recommendations: ['Aumentar gradualmente actividad física']
      },
      '4': {
        date: '05/02/2024',
        duration: '40 minutos',
        ...
        respAvg: '15 RPM',
        respRange: '13-18 RPM',
        notes: 'Sensores inerciales detectaron 6 eventos anómalos de tipo temblor de baja intensidad durante periodos de reposo.',
        symptoms: ['Temblores leves', 'Ansiedad'],
        recommendations: ['Evaluar componente ansioso', 'Revisar medicación actual']
      },
      '3': {
        date: '01/02/2024',
        duration: '30 minutos',
        ...
        respAvg: '16 RPM',
        respRange: '14-18 RPM',
        notes: 'La paciente presenta frecuencia cardíaca elevada durante parte de la sesión, lo que sugiere una respuesta exagerada al ejercicio.',
        symptoms: ['Fatiga intensa', 'Palpitaciones'],
        recommendations: ['Ajustar intensidad de ejercicios', 'Monitorizar respuesta cardiovascular']
      },
      '2': {
        date: '25/01/2024',
        duration: '40 minutos',
        ...
        respAvg: '17 RPM',
        respRange: '15-19 RPM',
        notes: 'Evaluación de seguimiento. Se observa mejora leve respecto a la evaluación inicial. Se ajusta tratamiento.',
        symptoms: ['Disnea moderada', 'Fatiga con actividades básicas'],
        recommendations: ['Continuar con rehabilitación respiratoria', 'Revisión de medicación']
      },
      '1': {
        date: '15/01/2024',
        duration: '50 minutos',
        ...
        respAvg: '18 RPM',
        respRange: '16-20 RPM',
        notes: 'Evaluación inicial completa. Se establece plan de tratamiento y monitorización. Se programa rehabilitación respiratoria.',
        symptoms: ['Disnea', 'Fatiga', 'Dificultad para actividades cotidianas'],
        recommendations: ['Iniciar programa de rehabilitación', 'Monitorización remota regular']
      }
    };
    
    // Función para abrir el diálogo de detalles de sesión
    const handleOpenSessionDetail = (sessionId: string) => {
      ...
      if (session) {
        setSessionDetailDialog({
          ...
          sessionData: sessionDetails[sessionId as keyof typeof sessionDetails] || {}
        });
      }
    };
    
    // Función para cerrar el diálogo de detalles de sesión
      ...
      <>
        <Paper sx={{ p: 3, mb: 3, borderRadius: 2, bgcolor: 'white' }}>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
            <Typography variant="h6" fontWeight="bold">Historial de Sesiones</Typography>
            <Typography variant="subtitle2" color="textSecondary">Total: 12 sesiones</Typography>
          </Box>
              ...
              <Grid item xs={12} sm={6} md={4} key={session.id}>
                ...
                >
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1 }}>
                    <Typography variant="subtitle1" fontWeight="medium" color={COLORS.primary}>
                      Sesión #{session.id}
          </Typography>
                    <Box sx={{ 
                      px: 1,
                      py: 0.5,
                      borderRadius: 1,
                      bgcolor: session.id === '12' ? 'rgba(76, 175, 80, 0.2)' : 'rgba(70, 128, 255, 0.2)',
                      fontSize: '0.75rem',
                      fontWeight: 'medium'
                    }}>
                      {session.id === '12' ? 'Última' : `#${session.id}`}
                    </Box>
                  </Box>
                  ...
                  <Typography variant="body2" color="textSecondary" sx={{ mb: 1 }}>
                    Tipo: {
                      sessionDetails[session.id as keyof typeof sessionDetails]?.type || 
                      (parseInt(session.id) > 8 ? 'Monitorización remota' : 
                      parseInt(session.id) > 4 ? 'Control de seguimiento' : 'Evaluación inicial')
                    }
          </Typography>
                  
                  <Box sx={{ mt: 'auto', pt: 1, borderTop: '1px dashed rgba(0, 0, 0, 0.1)', display: 'flex', justifyContent: 'flex-end' }}>
                    <Button 
                      variant="text" 
                      size="small" 
                      sx={{ 
        ...
        >
          <DialogTitle sx={{ 
            ...
            <Box>
              <Typography variant="h6" fontWeight="bold">
                Detalles de Sesión #{sessionDetailDialog.sessionId}
          </Typography>
              <Typography variant="subtitle2" color="textSecondary">
                {sessionDetailDialog.sessionDate} • {sessionDetailDialog.sessionData.duration}
          </Typography>
            </Box>
            <IconButton edge="end" color="inherit" onClick={handleCloseSessionDetail} aria-label="close">
              <CloseIcon />
            </IconButton>
          </DialogTitle>
                  ...
                  <Grid container spacing={2}>
                    <Grid item xs={12} sm={6} md={3}>
                      <Box>
                        ...
                        <Typography variant="body1">{sessionDetailDialog.sessionData.type}</Typography>
                      </Box>
                    </Grid>
                    <Grid item xs={12} sm={6} md={3}>
                      <Box>
                        <Typography variant="body2" color="textSecondary">Profesional</Typography>
                        <Typography variant="body1">{sessionDetailDialog.sessionData.professional}</Typography>
                      </Box>
                    </Grid>
                    <Grid item xs={12} sm={6} md={3}>
                      <Box>
                        <Typography variant="body2" color="textSecondary">Ubicación</Typography>
                        <Typography variant="body1">{sessionDetailDialog.sessionData.location}</Typography>
                      </Box>
                    </Grid>
                    <Grid item xs={12} sm={6} md={3}>
                      <Box>
                        <Typography variant="body2" color="textSecondary">Duración</Typography>
                        <Typography variant="body1">{sessionDetailDialog.sessionData.duration}</Typography>
                      </Box>
        </Grid>
      </Grid>
    </Paper>
          ...
          borderRadius: 1, 
                        ...
                        <Typography variant="body2" color="textSecondary" gutterBottom>SpO2 Promedio</Typography>
                        <Typography variant="h5" color={COLORS.primary} fontWeight="bold">{sessionDetailDialog.sessionData.spo2Avg}</Typography>
                        <Typography variant="caption" color="text.secondary">Rango: {sessionDetailDialog.sessionData.spo2Range}</Typography>
                      </Box>
                    </Grid>
                    <Grid item xs={12} sm={4}>
                      <Box sx={{ 
                        ...
                        <Typography variant="body2" color="textSecondary" gutterBottom>FC Promedio</Typography>
                        <Typography variant="h5" color={COLORS.redLine} fontWeight="bold">{sessionDetailDialog.sessionData.hrAvg}</Typography>
                        <Typography variant="caption" color="text.secondary">Rango: {sessionDetailDialog.sessionData.hrRange}</Typography>
                      </Box>
                    </Grid>
                    <Grid item xs={12} sm={4}>
                      <Box sx={{ 
                        ...
                        border: '1px solid rgba(31, 200, 227, 0.3)'
                      }}>
                        <Typography variant="body2" color="textSecondary" gutterBottom>FR Promedio</Typography>
                        <Typography variant="h5" color={COLORS.cyanLine} fontWeight="bold">{sessionDetailDialog.sessionData.respAvg}</Typography>
                        <Typography variant="caption" color="text.secondary">Rango: {sessionDetailDialog.sessionData.respRange}</Typography>
                      </Box>
                    </Grid>
                  </Grid>
                </Paper>
              ...
              <Grid item xs={12} md={6}>
                <Paper sx={{ p: 3, borderRadius: 2, height: '100%' }}>
                  ...
                  <Typography variant="body1" paragraph>
                    {sessionDetailDialog.sessionData.notes}
          </Typography>
                  ...
                  <Box component="ul" sx={{ pl: 2, mt: 1 }}>
                    {sessionDetailDialog.sessionData.recommendations?.map((rec: string, index: number) => (
              ...
              <Grid item xs={12} md={6}>
                <Paper sx={{ p: 3, borderRadius: 2, height: '100%' }}>
                  ...
                  <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1, mb: 3 }}>
                    {sessionDetailDialog.sessionData.symptoms?.map((symptom: string, index: number) => (
                      <Box 
                        key={index}
                        sx={{ 
                          px: 1.5, 
                  ...
                  <Box sx={{ display: 'flex', gap: 2, mt: 2 }}>
                    <Button 
                      ...
                      onClick={() => {
                        ...
                        handleSessionSelect(sessionDetailDialog.sessionId, sessionDetailDialog.sessionDate);
                      }}
          ...
          <DialogActions sx={{ p: 2, borderTop: `1px solid ${COLORS.gridLine}` }}>
            <Button onClick={handleCloseSessionDetail} sx={{ color: COLORS.primary }}>
              Cerrar
            </Button>
          </DialogActions>
        </Dialog>
  ...
  const QuestionnairesList = () => (
    <Paper sx={{ p: 3, mb: 3, borderRadius: 2, bgcolor: 'white' }}>
      <Typography variant="h6" fontWeight="bold" mb={2}>Evaluaciones</Typography>
  ...
  const handleOpenTrendHistory = (type: 'spo2' | 'fc' | 'spo2_events' | 'fc_events') => {
    ...
    <Box sx={{ 
      ...
      <Button
        ...
        sx={{
          ...
          bgcolor: selectedVitalsView === 'general' ? COLORS.primary : 'transparent',
          '&:hover': {
            bgcolor: selectedVitalsView === 'general' ? COLORS.secondary : 'rgba(0, 0, 0, 0.04)'
          }
        }}
      >
        Vista General
      ...
      <Button
        ...
        sx={{
          ...
          bgcolor: selectedVitalsView === 'realtime' ? COLORS.primary : 'transparent',
          '&:hover': {
            bgcolor: selectedVitalsView === 'realtime' ? COLORS.secondary : 'rgba(0, 0, 0, 0.04)'
          }
        }}
      >
        En Tiempo Real
      ...
      <Button
        ...
        sx={{
          ...
          bgcolor: selectedVitalsView === 'session' ? COLORS.primary : 'transparent',
          '&:hover': {
            bgcolor: selectedVitalsView === 'session' ? COLORS.secondary : 'rgba(0, 0, 0, 0.04)'
          }
        }}
      >
        Por Sesión
  ...
  const generateSpO2Data = () => {
    return availableSessions.map((_, index) => {
  ...
  const generateRespRateData = () => {
    return availableSessions.slice(0, 7).map((_, index) => {
      ...
      {selectedTab === 0 && (
        <>
          ...
          {selectedVitalsView === 'realtime' && (
            <Box sx={{ p: 3, borderRadius: 2, bgcolor: 'white', boxShadow: '0px 4px 10px rgba(0, 0, 0, 0.05)', mb: 6 }}>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
                <Typography variant="h6" fontWeight="bold">Datos del Sensor en Tiempo Real</Typography>
                <Button
                  variant="contained"
                  onClick={() => {
              ...
              <Grid container spacing={5}>
                ...
                <Grid item xs={12}>
                  <Box sx={{ 
                    ...
                    <Box sx={{ textAlign: 'center', p: 2 }}>
                      <Typography variant="body2" color="textSecondary">SpO2 Actual</Typography>
                      <Typography variant="h4" color={COLORS.primary} fontWeight="bold">95%</Typography>
                    </Box>
                    <Box sx={{ textAlign: 'center', p: 2 }}>
                      <Typography variant="body2" color="textSecondary">Frecuencia Cardíaca</Typography>
                      <Typography variant="h4" color={COLORS.redLine} fontWeight="bold">82 LPM</Typography>
                    </Box>
                    <Box sx={{ textAlign: 'center', p: 2 }}>
                      <Typography variant="body2" color="textSecondary">Frecuencia Respiratoria</Typography>
                      <Typography variant="h4" color={COLORS.cyanLine} fontWeight="bold">14 RPM</Typography>
                    </Box>
                  </Box>
                </Grid>
                ...
                <Grid item xs={12} md={6}>
                  <Box sx={{ 
                    ...
                    <Typography variant="subtitle1" fontWeight="medium" mb={2}>SpO2 en Tiempo Real</Typography>
                    ...
                    <Line
                      data={{
                        ...
                        datasets: [
                          {
                            label: 'SpO2 (%)',
                            data: Array.from({ length: 60 }, () => Math.floor(93 + Math.random() * 5)),
                            borderColor: COLORS.primary,
                            borderWidth: 2,
                            pointRadius: 0,
                            fill: false,
                ...
                <Grid item xs={12} md={6}>
                  <Box sx={{ 
                    ...
                    <Typography variant="subtitle1" fontWeight="medium" mb={2}>Frecuencia Cardíaca en Tiempo Real</Typography>
                    <Box sx={{ width: '100%', height: '310px' }}>
                    <Line
                      data={{
                        labels: Array.from({ length: 60 }, (_, i) => i.toString()),
                        datasets: [
                          {
                            label: 'FC (LPM)',
                            data: Array.from({ length: 60 }, () => Math.floor(70 + Math.random() * 20)),
                            borderColor: COLORS.redLine,
                            borderWidth: 2,
                            pointRadius: 0,
                            fill: false,
                ...
                <Grid item xs={12}>
                  <Box sx={{ 
                    ...
                    <Typography variant="subtitle1" fontWeight="medium" mb={2}>Frecuencia Respiratoria en Tiempo Real</Typography>
                    ...
                    <Line
                      data={{
                        ...
                        datasets: [
                          {
                            label: 'FR (RPM)',
                            data: Array.from({ length: 60 }, () => Math.floor(12 + Math.random() * 6)),
                            borderColor: COLORS.cyanLine,
                            borderWidth: 2,
                            pointRadius: 0,
                            fill: false,
                ...
                <Grid item xs={12}>
                  <Box sx={{ p: 2, bgcolor: COLORS.veryLightBlue, borderRadius: 1 }}>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
                      <Typography variant="subtitle1" fontWeight="medium">Estado de la Conexión</Typography>
                      <Button 
                        variant="text" 
                        size="small" 
                        sx={{ 
                    ...
                    <Box sx={{ 
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <Typography variant="h6" fontWeight="medium" color="success.main">Pulsioxímetro</Typography>
                        <Box sx={{ 
                          px: 2, 
                          py: 0.5, 
                      ...
                      <Grid container spacing={2} sx={{ mt: 1 }}>
                        <Grid item xs={12} sm={4}>
                          <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                            <Typography variant="body2" color="textSecondary">ID Dispositivo</Typography>
                            <Typography variant="body1" fontWeight="medium">SMARTM-OX22</Typography>
                          </Box>
                        </Grid>
                        <Grid item xs={12} sm={4}>
                          <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                            <Typography variant="body2" color="textSecondary">Calidad de Señal</Typography>
                            <Typography variant="body1" fontWeight="medium" color="success.main">Excelente</Typography>
                          </Box>
                        </Grid>
                        <Grid item xs={12} sm={4}>
                          <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                            <Typography variant="body2" color="textSecondary">Batería</Typography>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                              <Typography variant="body1" fontWeight="medium">85%</Typography>
                              <Box sx={{ 
                                width: 80, 
                                height: 12, 
                      ...
                      <Box sx={{ 
                        ...
                        <Typography variant="body2" color="textSecondary">Última comunicación: hace 2 segundos</Typography>
                        <Typography variant="body2" color="textSecondary">Sesión iniciada: 15:30</Typography>
                      </Box>
                    </Box>
                    ...
                    <Box sx={{ 
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <Typography variant="h6" fontWeight="medium" color="success.main">Sensor Inercial</Typography>
                        <Box sx={{ 
                          px: 2, 
                          py: 0.5, 
                          bgcolor: 'rgba(76, 175, 80, 0.8)', 
                      ...
                      <Grid container spacing={2} sx={{ mt: 1 }}>
                        <Grid item xs={12} sm={4}>
                          <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                            <Typography variant="body2" color="textSecondary">ID Dispositivo</Typography>
                            <Typography variant="body1" fontWeight="medium">SMARTM-INR15</Typography>
                          </Box>
                        </Grid>
                        <Grid item xs={12} sm={4}>
                          <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                            <Typography variant="body2" color="textSecondary">Calidad de Señal</Typography>
                            <Typography variant="body1" fontWeight="medium" color="success.main">Buena</Typography>
                          </Box>
                        </Grid>
                        <Grid item xs={12} sm={4}>
                          <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                            <Typography variant="body2" color="textSecondary">Batería</Typography>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                              <Typography variant="body1" fontWeight="medium">72%</Typography>
                              <Box sx={{ 
                                width: 80, 
                                height: 12, 
                                bgcolor: 'rgba(0,0,0,0.1)', 
                      ...
                      <Box sx={{ 
                        ...
                        <Typography variant="body2" color="textSecondary">Última comunicación: hace 5 segundos</Typography>
                        <Typography variant="body2" color="textSecondary">Sesión iniciada: 15:30</Typography>
                      </Box>
                    </Box>
                    ...
                    <Box sx={{ 
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <Typography variant="h6" fontWeight="medium" color="warning.main">Mascarilla</Typography>
                        <Box sx={{ 
                          px: 2, 
                          py: 0.5, 
                      ...
                      <Grid container spacing={2} sx={{ mt: 1 }}>
                        <Grid item xs={12} sm={4}>
                          <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                            <Typography variant="body2" color="textSecondary">ID Dispositivo</Typography>
                            <Typography variant="body1" fontWeight="medium">SMARTM-ECG08</Typography>
                          </Box>
                        </Grid>
                        <Grid item xs={12} sm={4}>
                          <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                        ...
                        <Grid item xs={12} sm={4}>
                          <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                            <Typography variant="body2" color="textSecondary">Batería</Typography>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                              <Typography variant="body1" fontWeight="medium" color="warning.main">18%</Typography>
                              <Box sx={{ 
                                width: 80, 
                                height: 12, 
                                bgcolor: 'rgba(0,0,0,0.1)', 
                      ...
                      <Box sx={{ 
                        ...
                        <Typography variant="body2" color="textSecondary">Última comunicación: hace 8 segundos</Typography>
                        <Typography variant="body2" color="textSecondary">Sesión iniciada: 15:30</Typography>
                      </Box>
                    </Box>
          ...
          {selectedVitalsView === 'lastSession' && (
            <Paper sx={{ p: 3, mb: 3, borderRadius: 2, bgcolor: 'white' }}>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
                <Typography variant="h6" fontWeight="bold">Detalle de la Última Sesión</Typography>
                <Typography variant="subtitle2" color="textSecondary">Fecha: 15/03/2024</Typography>
              </Box>
              
        <Grid container spacing={3}>
                <Grid item xs={12}>
                  <Box sx={{ p: 2, bgcolor: COLORS.veryLightBlue, borderRadius: 1, mb: 2 }}>
                    <Typography variant="subtitle1" fontWeight="medium" mb={1}>Resumen de Signos Vitales</Typography>
                    <Grid container spacing={4}>
                      <Grid item xs={6} sm={3}>
                        <Box sx={{ textAlign: 'center', p: 1 }}>
                          <Typography variant="body2" color="textSecondary">SpO2 Promedio</Typography>
                          <Typography variant="h6" color={COLORS.primary} fontWeight="bold">94%</Typography>
                          <Typography variant="caption" color="text.secondary">Rango: 93-97%</Typography>
                        </Box>
                      </Grid>
                      <Grid item xs={6} sm={3}>
                        <Box sx={{ textAlign: 'center', p: 1 }}>
                          <Typography variant="body2" color="textSecondary">FC Promedio</Typography>
                          <Typography variant="h6" color={COLORS.primary} fontWeight="bold">78 LPM</Typography>
                          <Typography variant="caption" color="text.secondary">Rango: 70-85 LPM</Typography>
                        </Box>
                      </Grid>
                      <Grid item xs={6} sm={3}>
                        <Box sx={{ textAlign: 'center', p: 1 }}>
                          <Typography variant="body2" color="textSecondary">FR Promedio</Typography>
                          <Typography variant="h6" color={COLORS.primary} fontWeight="bold">16 RPM</Typography>
                          <Typography variant="caption" color="text.secondary">Rango: 14-18 RPM</Typography>
                        </Box>
                      </Grid>
                      <Grid item xs={6} sm={3}>
                        <Box sx={{ textAlign: 'center', p: 1 }}>
                          <Typography variant="body2" color="textSecondary">Duración</Typography>
                          <Typography variant="h6" color={COLORS.primary} fontWeight="bold">45 min</Typography>
                          <Typography variant="caption" color="text.secondary">15/03/2024</Typography>
                        </Box>
                      </Grid>
                    </Grid>
                  </Box>
                  ...
                  <Box sx={{ 
                    ...
                    <Box sx={{ p: 1 }}>
                      ...
                      <Typography variant="body1">
                        Durante esta sesión, la paciente presentó variabilidad en la frecuencia cardíaca al realizar ejercicios de respiración profunda. Se realizaron ajustes en la postura que mejoraron los valores de oxigenación. La paciente reporta sensación de bienestar y menos fatiga al finalizar la sesión.
                      </Typography>
                    </Box>
                  </Box>
                </Grid>
                ...
                <Grid item xs={12}>
                  <Box sx={{ 
                    ...
                    <Typography variant="subtitle1" fontWeight="medium" mb={1}>Evolución Durante la Sesión</Typography>
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 2, width: '95%' }}>
                      <Button 
              ...
              {selectedVitalsView === 'general' && (
                <Paper sx={{ p: 3, mb: 3, borderRadius: 2, bgcolor: 'white' }}>
                  ...
                  <Grid container spacing={4}>
                    <Grid item xs={12}>
                      <Box sx={{ p: 2, bgcolor: COLORS.veryLightBlue, borderRadius: 1, mb: 2 }}>
                        <Typography variant="subtitle1" fontWeight="medium" mb={1}>Promedios Generales Últimas 3 Sesiones</Typography>
                        <Grid container spacing={2}>
                          <Grid item xs={6} sm={3}>
                            <Box sx={{ textAlign: 'center', p: 1 }}>
                              <Typography variant="body2" color="textSecondary">SpO2 Promedio</Typography>
                              <Typography variant="h6" color={COLORS.primary} fontWeight="bold">95%</Typography>
                              <Typography variant="caption" color="text.secondary">Rango: 93-98%</Typography>
                            </Box>
                          </Grid>
                          <Grid item xs={6} sm={3}>
                            <Box sx={{ textAlign: 'center', p: 1 }}>
                              <Typography variant="body2" color="textSecondary">FC Promedio</Typography>
                              <Typography variant="h6" color="#ff4569" fontWeight="bold">76 LPM</Typography>
                              <Typography variant="caption" color="text.secondary">Rango: 68-88 LPM</Typography>
                            </Box>
                          </Grid>
                          <Grid item xs={6} sm={3}>
                            <Box sx={{ textAlign: 'center', p: 1 }}>
                              <Typography variant="body2" color="textSecondary">FR Promedio</Typography>
                              <Typography variant="h6" color="#1fc8e3" fontWeight="bold">14 RPM</Typography>
                              <Typography variant="caption" color="text.secondary">Rango: 12-18 RPM</Typography>
                            </Box>
                          </Grid>
                          <Grid item xs={6} sm={3}>
                            <Box sx={{ textAlign: 'center', p: 1 }}>
                              <Typography variant="body2" color="textSecondary">Tiempo Total</Typography>
                              <Typography variant="h6" color={COLORS.primary} fontWeight="bold">9h 15m</Typography>
                              <Typography variant="caption" color="text.secondary">Desde: 10/01/2024</Typography>
                            </Box>
                          </Grid>
                        </Grid>
                      </Box>
                    ...
                    <Grid item xs={12} md={6}>
                      <Box sx={{ p: 2, bgcolor: COLORS.veryLightBlue, borderRadius: 1 }}>
                        <Typography variant="subtitle1" fontWeight="medium" mb={1}>Progreso</Typography>
                        <Grid container spacing={2}>
                          <Grid item xs={12} sm={6}>
                            <Box sx={{ 
                              ...
                              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1 }}>
                                <Typography variant="body2" color="textSecondary">Tendencia SpO2</Typography>
                                <Button
                                  size="small"
                                  sx={{
                                    color: COLORS.primary,
                              ...
                              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                <Typography variant="body1" fontWeight="medium" color={COLORS.primary}>Estable</Typography>
                          ...
                          <Grid item xs={12} sm={6}>
                            <Box sx={{ 
                              ...
                              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1 }}>
                                <Typography variant="body2" color="textSecondary">Tendencia FC</Typography>
                                <Button
                                  size="small"
                                  sx={{
                                    color: COLORS.primary,
                              ...
                              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                <Typography variant="body1" fontWeight="medium" color={COLORS.primary}>Mejorando</Typography>
                                <Typography variant="body2" color="success.main">-3.5 LPM</Typography>
                              </Box>
                            </Box>
                          </Grid>
                        </Grid>
                    ...
                    <Grid item xs={12} md={6}>
                      <Box sx={{ p: 2, bgcolor: COLORS.veryLightBlue, borderRadius: 1 }}>
                        <Typography variant="subtitle1" fontWeight="medium" mb={1}>Eventos Notables</Typography>
                        <Grid container spacing={4}>
                          <Grid item xs={12} md={6}>
                            <Box sx={{ 
                              p: 2, 
                              ...
                              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1 }}>
                                <Typography variant="body2" color="error.main">SpO2 &lt; 90%</Typography>
                                <Button
                                  size="small"
                                  sx={{
                                    color: COLORS.primary,
                                  ...
                                  onClick={() => handleOpenTrendHistory('spo2_events')}
                                >
                                  Historial
                                </Button>
                              </Box>
                              <Typography variant="body1">2 eventos (última: 15/03/2024)</Typography>
                            </Box>
                          </Grid>
                          <Grid item xs={12} md={6}>
                            <Box sx={{ 
                              ...
                              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1 }}>
                                <Typography variant="body2" color="info.main">FC &gt; 100 LPM</Typography>
                                <Button
                                  size="small"
                                  sx={{
                                    color: COLORS.primary,
                                  ...
                                  onClick={() => handleOpenTrendHistory('fc_events')}
                                >
                                  Historial
                                </Button>
                              </Box>
                              <Typography variant="body1">3 eventos (última: 01/03/2024)</Typography>
                            </Box>
                          </Grid>
                        </Grid>
                      </Box>
                    ...
                    <Grid item xs={12}>
                      <Box sx={{ 
                        ...
                        <Box sx={{ p: 1 }}>
                          ...
                          <Typography variant="body1">
                            La paciente muestra una evolución favorable en los parámetros cardiovasculares. Los episodios de desaturación son aislados y no persistentes.
                            Se recomienda continuar con el mismo esquema de monitorización y mantener la frecuencia de las sesiones actuales.
                          </Typography>
                        </Box>
                      </Box>
                    </Grid>
...
{selectedVitalsView === 'general' && (
                <Paper sx={{ p: 3, mb: 3, borderRadius: 2, bgcolor: 'white' }}>
                  ...
                  <Box>
                    <Typography variant="subtitle1" fontWeight="medium" mb={1}>Rango de Fechas</Typography>
                    <Grid container spacing={2}>
                      <Grid item xs={12} sm={6}>
                        <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                          <label htmlFor="start-date" style={{ marginBottom: '4px' }}>Fecha Inicio</label>
                          <input 
                            type="date" 
                            id="start-date"
                            value={customConfig.startDate}
                            onChange={(e) => handleCustomConfigChange({ startDate: e.target.value })}
                      ...
                      <Grid item xs={12} sm={6}>
                        <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                          <label htmlFor="end-date" style={{ marginBottom: '4px' }}>Fecha Fin</label>
                          <input 
                            type="date" 
                            id="end-date"
                            value={customConfig.endDate}
                            onChange={(e) => handleCustomConfigChange({ endDate: e.target.value })}
                            style={{ padding: '8px', borderRadius: '4px', border: '1px solid #ddd' }}
                          />
                        </Box>
                      </Grid>
          ...
          {/* Saturación de oxígeno */}
                {(selectedVitalsView === 'general' || (selectedVitalsView === 'custom' && customConfig.showSpo2)) && (
          <Grid item xs={12} md={6}>
            <Paper 
              sx={{ 
                p: 3, 
          ...
          {/* Frecuencia cardiaca */}
                {(selectedVitalsView === 'general' || (selectedVitalsView === 'custom' && customConfig.showHeartRate)) && (
          <Grid item xs={12} md={6}>
            <Paper 
              sx={{ 
                p: 3, 
          ...
          {/* Frecuencia Respiratoria */}
                {(selectedVitalsView === 'general' || (selectedVitalsView === 'custom' && customConfig.showRespRate)) && (
          <Grid item xs={12} md={6}>
            <Paper 
              sx={{ 
                p: 3, 
          ...
          {/* Sensores Inerciales */}
                {(selectedVitalsView === 'general' || (selectedVitalsView === 'custom' && customConfig.showInertial)) && (
          <Grid item xs={12} md={6}>
            <Paper 
              sx={{ 
                p: 3, 
            ...
            >
              <Box sx={cardHeaderStyle}>
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  <Typography variant="h6" fontWeight="bold" color="textPrimary">EVENTOS ANOMALOS DEL MOVIMIENTO</Typography>
      ...
      {selectedTab === 1 && <EncountersList />}
      {selectedTab === 2 && <QuestionnairesList />}
      ...
      {selectedTab === 0 && selectedVitalsView === 'session' && (
        <Paper sx={{ mb: 4, p: 3, borderRadius: 2, boxShadow: '0px 3px 6px rgba(0, 0, 0, 0.08)' }}>
                      ...
                      <Box sx={{ p: 2, bgcolor: COLORS.veryLightBlue, borderRadius: 1, mb: 2 }}>
                        <Grid container spacing={2}>
                          <Grid item xs={6} sm={3}>
                            <Box sx={{ textAlign: 'center', p: 1 }}>
                              <Typography variant="body2" color="textSecondary">SpO2 Promedio</Typography>
                              <Typography variant="h6" color={COLORS.primary} fontWeight="bold">96%</Typography>
                              <Typography variant="caption" color="text.secondary">Rango: 95-97%</Typography>
                            </Box>
                          </Grid>
                          <Grid item xs={6} sm={3}>
                            <Box sx={{ textAlign: 'center', p: 1 }}>
                              <Typography variant="body2" color="textSecondary">FC Promedio</Typography>
                              <Typography variant="h6" color="#ff4569" fontWeight="bold">99 LPM</Typography>
                              <Typography variant="caption" color="text.secondary">Rango: 78-109 LPM</Typography>
                            </Box>
                          </Grid>
                          <Grid item xs={6} sm={3}>
                            <Box sx={{ textAlign: 'center', p: 1 }}>
                              <Typography variant="body2" color="textSecondary">FR Promedio</Typography>
                              <Typography variant="h6" color="#1fc8e3" fontWeight="bold">16 RPM</Typography>
                              <Typography variant="caption" color="text.secondary">Rango: 14-18 RPM</Typography>
                            </Box>
                          </Grid>
                          <Grid item xs={6} sm={3}>
                            <Box sx={{ textAlign: 'center', p: 1 }}>
                              <Typography variant="body2" color="textSecondary">Tiempo Sesión</Typography>
                              <Typography variant="h6" color={COLORS.primary} fontWeight="bold">45m</Typography>
                            </Box>
                          </Grid>
                        </Grid>
                      </Box>
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <Box sx={{ 
                ...
                <Typography variant="body2" gutterBottom>
                  <strong>SpO2 &lt; 90%</strong> - Detectado a las 10:23 AM (88%)
                </Typography>
                <Typography variant="body2">
                  Duración: 45 segundos • Se resolvió espontáneamente sin intervención
                </Typography>
              </Box>
            </Box>
          )}
          ...
          {selectedSession.id === '9' && (
            <Box sx={{ mb: 4 }}>
              <Typography variant="subtitle1" fontWeight="medium" color="info.main" gutterBottom>
                Eventos Detectados
              </Typography>
              <Box sx={{ 
                p: 2, 
                ...
                <Typography variant="body2" gutterBottom>
                  <strong>FC &gt; 100 LPM</strong> - Detectado a las 09:45 AM (102 LPM)
                </Typography>
                <Typography variant="body2">
          ...
          <Box sx={{ 
            ...
            <Typography variant="subtitle1" fontWeight="medium" sx={{ color: COLORS.primary }} gutterBottom>
              Observaciones de Profesional
            </Typography>
            <Button
      variant="contained"
    ...
    >
      Agregar Observación
            ...
            <Paper sx={{ 
              ...
              {selectedSession.id === '12' && (
                <>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    <Avatar sx={{ bgcolor: COLORS.primary, width: 40, height: 40, mr: 2 }}>DR</Avatar>
                    <Box>
                      <Typography variant="subtitle2">Dr. Ricardo Torres</Typography>
                      <Typography variant="caption" color="text.secondary">Neumólogo • 08/04/2024</Typography>
                    </Box>
                  </Box>
                  <Typography variant="body2" paragraph>
                    Paciente presenta episodio transitorio de desaturación que coincide con maniobra de tos. Se observa buena recuperación sin necesidad de oxigenoterapia suplementaria.
                  </Typography>
                  <Typography variant="body2" paragraph>
                    Mantiene buena mecánica ventilatoria y respuesta adecuada al esfuerzo en los ejercicios respiratorios. Mejoría en tolerancia a actividad física comparado con sesiones anteriores.
                  </Typography>
                  <Typography variant="body2" sx={{ color: COLORS.primary, fontWeight: 'medium' }}>
                    Recomendación: Continuar con el plan de ejercicios respiratorios enfocados en aumento progresivo de carga. Vigilar SpO2 durante actividades con mayor demanda.
                  </Typography>
                </>
              )}
              ...
              {selectedSession.id === '9' && (
                <>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    <Avatar sx={{ bgcolor: COLORS.redLine, width: 40, height: 40, mr: 2 }}>MM</Avatar>
                    <Box>
                      <Typography variant="subtitle2">Dra. María Morales</Typography>
                      <Typography variant="caption" color="text.secondary">Cardióloga • 01/03/2024</Typography>
                    </Box>
                  </Box>
                  <Typography variant="body2" paragraph>
                    Se observa tendencia al aumento de frecuencia cardíaca con actividades de baja intensidad. La paciente refiere sensación de palpitaciones ocasionales que coinciden con los picos registrados en FC.
                  </Typography>
                  <Typography variant="body2" paragraph>
                    Los datos de sensores inerciales muestran desvíos posturales que podrían estar relacionados con compensación por fatiga muscular prematura.
                  </Typography>
                  <Typography variant="body2" sx={{ color: COLORS.redLine, fontWeight: 'medium' }}>
                    Recomendación: Ajustar intensidad de ejercicios cardiovasculares. Considerar valoración de medicación. Implementar ejercicios específicos para corrección postural.
                  </Typography>
                </>
              )}
          ...
          <Grid container spacing={3}>
              ...
              >
                      ...
                      datasets: [
                        {
                          label: 'SpO2 (%)',
                          data: [
                            ...Array.from({ length: 10 }, () => Math.floor(Math.random() * 3 + 96)),
                            ...Array.from({ length: 15 }, () => Math.floor(Math.random() * 3 + 94)),
                            ...(selectedSession.id === '12' ? [88] : [Math.floor(Math.random() * 3 + 94)]),
                            ...Array.from({ length: 19 }, () => Math.floor(Math.random() * 3 + 95))
                          ],
                          borderColor: COLORS.primary,
                          backgroundColor: 'transparent',
                          borderWidth: 2,
                          tension: 0.4,
                          pointRadius: (ctx) => ctx.dataIndex === 26 && selectedSession.id === '12' ? 5 : 0,
                          pointBackgroundColor: COLORS.primary
                        }
                      ]
                    }}
                ...
                <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 2 }}>
                  ...
                  <Button 
                    ...
                    onClick={() => handleOpenDetail(
                      'SATURACIÓN DE OXÍGENO (%) - SESIÓN #' + selectedSession.id, 
                      selectedSession.id === '12' ? '88%' : '96%', 
                      'spo2_session',
                      selectedSession.id === '12' 
              ...
              >
                      ...
                      datasets: [
                        {
                          label: 'FC (LPM)',
                          data: [
                            ...Array.from({ length: 15 }, () => Math.floor(Math.random() * 10 + 78)),
                            ...(selectedSession.id === '9' ? [102, 103, 101] : Array.from({ length: 3 }, () => Math.floor(Math.random() * 6 + 70))),
                            ...Array.from({ length: 27 }, () => Math.floor(Math.random() * 10 + 99))
                          ],
                          borderColor: COLORS.redLine,
                          backgroundColor: 'transparent',
                          borderWidth: 2,
                          tension: 0.4,
                          pointRadius: (ctx) => (ctx.dataIndex >= 15 && ctx.dataIndex <= 17 && selectedSession.id === '9') ? 5 : 0,
                          pointBackgroundColor: COLORS.redLine
                        }
                      ]
                    }}
                ...
                <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 2 }}>
                  ...
                  <Button 
                    ...
                    onClick={() => handleOpenDetail(
                      'FRECUENCIA CARDIACA (LPM) - SESIÓN #' + selectedSession.id, 
                      selectedSession.id === '9' ? '102 LPM' : '99 LPM', 
                      'heart_rate_session',
                      selectedSession.id === '9' 
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                <Box sx={cardHeaderStyle}>
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    <Typography variant="h6" fontWeight="bold" color="textPrimary">ACELERÓMETRO (m/s²)</Typography>
                    <MuiTooltip title="El acelerómetro mide la aceleración en los ejes X, Y y Z. Permite detectar movimientos, cambios de posición y patrones de actividad." arrow placement="top">
                      <IconButton size="small" sx={{ ml: 1 }}>
                        <HelpOutlineIcon fontSize="small" color="primary" />
                      </IconButton>
                    </MuiTooltip>
                  ...
                  <Line
                    data={{
                      ...
                      datasets: [
                        {
                          label: 'Eje X',
                          data: Array.from({ length: 45 }, () => (Math.random() * 2 - 1).toFixed(2)),
                          borderColor: COLORS.primary,
                          backgroundColor: 'transparent',
                          borderWidth: 1.5,
                          tension: 0.2
                        ...
                        {
                          label: 'Eje Z',
                          data: Array.from({ length: 45 }, () => (Math.random() * 2 + 8).toFixed(2)),
                          borderColor: COLORS.cyanLine,
                          backgroundColor: 'transparent',
                          borderWidth: 1.5,
                          tension: 0.2
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                <Box sx={cardHeaderStyle}>
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    <Typography variant="h6" fontWeight="bold" color="textPrimary">GIROSCOPIO (rad/s)</Typography>
                    <MuiTooltip title="El giroscopio mide la velocidad angular en los ejes X, Y y Z. Permite detectar rotaciones, giros y orientación espacial del paciente." arrow placement="top">
                      <IconButton size="small" sx={{ ml: 1 }}>
                        <HelpOutlineIcon fontSize="small" color="primary" />
                      </IconButton>
                    </MuiTooltip>
                  ...
                  <Line
                    data={{
                      ...
                      datasets: [
                        {
                          label: 'Eje X',
                          data: Array.from({ length: 45 }, () => (Math.random() * 0.5 - 0.25).toFixed(2)),
              ...
              >
                  ...
                  <Line
                    data={{
                      ...
                      datasets: [
                        {
                          label: 'FR (RPM)',
                          data: Array.from({ length: 45 }, () => Math.floor(Math.random() * 4 + 13)),
                          borderColor: COLORS.cyanLine,
                          backgroundColor: 'transparent',
                          borderWidth: 2,
                          tension: 0.4,
                ...
                <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 2 }}>
                  ...
                  <Button 
                    ...
                    onClick={() => handleOpenDetail(
                      'FRECUENCIA RESPIRATORIA (RPM) - SESIÓN #' + selectedSession.id, 
                      '15 RPM', 
                      'resp_rate_session',
      ...
      >
        <DialogTitle sx={{ 
          ...
          <IconButton edge="end" color="inherit" onClick={() => setObservationsHistoryOpen(false)} aria-label="close">
            <CloseIcon />
          </IconButton>
        </DialogTitle>
        <DialogContent sx={{ p: 3, bgcolor: COLORS.lightGrey }}>
          <Box sx={{ bgcolor: 'white', p: 3, borderRadius: 2, mb: 2 }}>
            <Box sx={{ mb: 2, pb: 2, borderBottom: `1px solid ${COLORS.gridLine}` }}>
            ...
            <Box sx={{ mb: 2, pb: 2, borderBottom: `1px solid ${COLORS.gridLine}` }}>
              ...
              <Typography variant="body1">
                Se observa un ligero episodio de desaturación durante la sesión que se recupera espontáneamente. La tendencia general de los signos vitales es estable.
                Se debe vigilar la frecuencia cardíaca, que muestra oscilaciones al final de la sesión.
              </Typography>
            </Box>
            ...
            <Box sx={{ mb: 2, pb: 2, borderBottom: `1px solid ${COLORS.gridLine}` }}>
              ...
              <Typography variant="body1">
                Los parámetros cardiorrespiratorios se mantienen dentro de límites normales durante toda la sesión.
                El tratamiento muestra buenos resultados y la tolerancia a la actividad física ha mejorado considerablemente desde la sesión anterior.
              </Typography>
            </Box>
            ...
            <Box>
              ...
              <Typography variant="body1">
                La paciente presenta frecuencia cardíaca elevada durante parte de la sesión, lo que sugiere una respuesta exagerada al ejercicio.
                Se recomienda ajustar la intensidad de la actividad física y monitorizar de cerca la respuesta cardiovascular en las próximas sesiones.
              </Typography>
            </Box>
          </Box>
        </DialogContent>
        <DialogActions sx={{ p: 2, borderTop: `1px solid ${COLORS.gridLine}` }}>
          <Button onClick={() => setObservationsHistoryOpen(false)} sx={{ color: COLORS.primary }}>
            Cerrar
          </Button>
        </DialogActions>
      </Dialog>
